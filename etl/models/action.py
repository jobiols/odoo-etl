...
class Action(models.Model):
    ...
    def run_action(self, source_connection=False, target_connection=False,
        ...
        source_fields.extend([x.source_field for x in self.field_mapping_ids
        ...
        target_fields.extend([x.target_field for x in self.field_mapping_ids
                              if x.state == state and
                              x.type == 'field' and
                              x.source_field_id.ttype != 'many2many' and
                              x.source_field_id.ttype != 'many2one'])
        ...
        source_fields_m2o = [x.id for x in self.field_mapping_ids
        ...
        # Read and append source values of type 'field' and type m2m
        source_fields_m2m = [x.id for x in self.field_mapping_ids
        ...
        field_mapping_expression_ids = [x.id for x in self.field_mapping_ids
                                        if x.state == state
        ...
        field_mapping_migrated_id_ids = [x.id for x in self.field_mapping_ids
                                         if x.state == state
                                         and x.type == 'migrated_id']
        ...
        field_mapping_reference_ids = [x.id for x in self.field_mapping_ids
                                       if x.state == state
